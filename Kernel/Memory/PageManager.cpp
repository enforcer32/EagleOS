...
namespace Kernel
{
	...
	namespace Memory
	{
		...
		bool PageManager::MapRange(uint32_t virtualAddress, uint32_t physicalAddress, bool writable, uint32_t count)
		{
			...
			//m_PageDirectory.DumpPageDirectoryEntry(0xC0000000);
			//m_PageTable768.DumpPageTableEntry(0xC0000000 + (0 * 4096));	
			return true;
		}

		void PageManager::Temp()
		{
			m_PageDirectory.DumpPageDirectoryEntry(0x0);
			//m_PageTable0.DumpPageTableEntries(0);

			
			//m_PageDirectory.DumpPageDirectoryEntry(0xC0000000);
			//m_PageTable768.DumpPageTableEntries(768);	
		}
